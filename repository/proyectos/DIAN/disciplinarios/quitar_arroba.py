...
def main():
    ...
    archivo_entrada_nombre = "consolidado_final_disciplinario_Ene_Dic_2022.csv"
    ...
    ruta_salida = os.path.join(base_path, "consolidado_final_disciplinario_Ene_Dic_2022_sin_arrobas.csv")
