...
if __name__ == "__main__":
    from validadores.validadores_pqr_dynamics import ValidadoresPQRDynamics
    
    processor = CSVProcessor(validator=ValidadoresPQRDynamics())
    ...
    "nit": [5],
    "choice_direccion_seccional": [24]
}

    base_path = os.path.expanduser("~/Documentos/ITRC/DOCUMENTOS_LIMPIAR/copia_DIAN_PQRS/2024/DYNAMICS/CSV/")
    input_file = os.path.join(base_path, "ITRC_Septiembre_2024_Sistema_PQSRD_Dynamics_365_4-10-2024.csv")
    output_file = os.path.join(base_path, "ITRC_Septiembre_2024_Sistema_PQSRD_Dynamics_365_4-10-2024_procesado.csv")
    error_file = os.path.join(base_path, "ITRC_Septiembre_2024_Sistema_PQSRD_Dynamics_365_4-10-2024_errores_procesamiento.csv")

    
    processor.process_csv(input_file, output_file, error_file, type_mapping)


# ITRC_Octubre_2024_Sistema_PQSRD_Dynamics_365_7-11-2024.csv
# ITRC_Septiembre_2024_Sistema_PQSRD_Dynamics_365_4-10-2024.csv
